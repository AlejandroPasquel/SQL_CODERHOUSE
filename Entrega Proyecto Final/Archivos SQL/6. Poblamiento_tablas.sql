...
INSERT INTO tienda (cod_tienda, ciudad, tipologia, tamano_mt2, numero_fabrica)
VALUES
...
INSERT INTO cliente (cedula, nombre, telefono, tipo, email, codigo_tienda) VALUES
...
INSERT INTO venta (cod_venta, codigo_cliente, codigo_producto, cantidad, precio_total, fecha_pedido) VALUES
...
VALUES
    (1, 'TechSupplier Inc.', 'Juan Pérez', '3001234567', 'contacto@techsupplier.com'),
    (2, 'Global Hardware Ltd.', 'María Gómez', '3102345678', 'ventas@globalhardware.com'),
    (3, 'ElectroParts SA', 'Carlos Rodríguez', '3203456789', 'info@electroparts.com'),
    (4, 'Componentes Express', 'Ana López', '3304567890', 'soporte@componentesexpress.com'),
    (5, 'Distribuidora PC', 'Pedro Martínez', '3405678901', 'contacto@distribuidorapc.com');

-- Tabla empleado
INSERT INTO empleado (cod_empleado, nombre, puesto, salario, cod_fabrica)
VALUES
    (1, 'Laura García', 'Gerente de Logística', 4500.00, 1),
    (2, 'José Fernández', 'Operador de Almacén', 2800.00, 2),
    (3, 'Lucía Díaz', 'Supervisor de Envíos', 3200.00, 3),
    (4, 'Santiago Pérez', 'Analista de Inventarios', 3500.00, 4),
    (5, 'Isabel Hernández', 'Coordinador de Distribución', 4000.00, 5);

-- tabla envio 
INSERT INTO envio (cod_envio, cod_venta, fecha_envio, estado)
VALUES
    (1, 'VXP9B8F4G1', '2024-01-12', 'En tránsito'),
    (2, 'AXD7J6W3N2', '2024-01-13', 'Entregado'),
    (3, 'K8Z4N1D7P6', '2024-01-14', 'Pendiente'),
    (4, 'W1L9E3C7U0', '2024-01-15', 'En tránsito'),
    (5, 'P4M2I7A1G5', '2024-01-16', 'Entregado'),
    (6, 'S0H8U1B3K6', '2024-01-17', 'Pendiente'),
    (7, 'J3D4L2P9K0', '2024-01-18', 'En tránsito'),
    (8, 'B7T2Y5Q9V4', '2024-01-19', 'Entregado'),
    (9, 'G1M5D7O9N2', '2024-01-20', 'Pendiente'),
    (10, 'C9V8Z1S6Q3', '2024-01-21', 'En tránsito'),
    (11, 'O7Y3X2F8M9', '2024-01-22', 'Entregado'),
    (12, 'E8J4C9I1H7', '2024-01-23', 'Pendiente'),
    (13, 'R2K1V9W4G8', '2024-01-24', 'En tránsito'),
    (14, 'D5T9P7M2Q0', '2024-01-25', 'Entregado'),
    (15, 'V6Z2G8X1P5', '2024-01-26', 'Pendiente'),
    (16, 'N1C0L3P8M2', '2024-01-27', 'En tránsito'),
    (17, 'F2J8Q4X7U1', '2024-01-28', 'Entregado'),
    (18, 'B9T3V6W2Y4', '2024-01-29', 'Pendiente'),
    (19, 'P4M0F7S1X8', '2024-01-30', 'En tránsito'),
    (20, 'Q3C9M8J2P0', '2024-01-31', 'Entregado');
    
/* -----Ejecucion de Vistas / Funciones / Procedimientos almacenados y Triggers */

-- Vistas:

SELECT * FROM vw_ventas_detalladas;
SELECT * FROM vw_tiendas_rendimiento;
SELECT * FROM vw_clientes_compra;
